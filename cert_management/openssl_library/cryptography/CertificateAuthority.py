    ...
    def create(self, key):
        subject = issuer = x509.Name(
            [
                ...
                x509.NameAttribute(
                    NameOID.STATE_OR_PROVINCE_NAME, "Mato Grosso do Sul"
                ),
                x509.NameAttribute(NameOID.LOCALITY_NAME, "Mato Grosso do Sul"),
                x509.NameAttribute(NameOID.ORGANIZATION_NAME, "TI"),
